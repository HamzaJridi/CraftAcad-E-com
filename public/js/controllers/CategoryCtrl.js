angular.module('myApp').controller('SuitsCtrl', ['$scope', '$http', 'AuthService',
...
angular.module('myApp').controller('CasualCtrl', ['$scope', '$http', 'AuthService',
    function ($scope, $http, AuthService) {
...
angular.module('myApp').controller('SportCtrl', ['$scope', '$http', 'AuthService',
    function ($scope, $http, AuthService) {
...
angular.module('myApp').controller('RoomCtrl', ['$scope', '$http', 'AuthService', '$rootScope',
